...
//            FirebaseModelInputs inputs = new FirebaseModelInputs.Builder().add(imgData).build();
            FirebaseModelInputs inputs = new FirebaseModelInputs.Builder().add(imgData2).build();
...
//                                }
    ...
    private ByteBuffer convertBitmapToByteBuffer2(Bitmap bitmap) {
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(4 * DIM_BATCH_SIZE * DIM_IMG_SIZE_X * DIM_IMG_SIZE_Y * DIM_PIXEL_SIZE);
        ...
        private int degreesToFirebaseRotation(int degrees){
            switch (degrees){
                ...
                case 270:
                    ...
                    default:
                        throw new IllegalArgumentException("각도는 0, 90, 180, 270도만 변환 가능합니다.");
            }
        }
